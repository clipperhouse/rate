...
func BenchmarkLimiter_Allow_SingleBucket(b *testing.B) {
	keyer := func(id int) string {
		return "allow-single-bucket"
	}
...
func BenchmarkLimiter_Allow_MultipleBuckets(b *testing.B) {
	const buckets = 1000
...
func BenchmarkLimiter_AllowWithDetails_SingleBucket(b *testing.B) {
	keyer := func(id int) string {
		return "allow-details-single-bucket"
	}
...
func BenchmarkLimiter_AllowWithDetails_MultipleBuckets(b *testing.B) {
	const buckets = 1000
	keyer := func(id int) int {
		return id
	}
